...
var startPopupTextInputField = document.getElementById( "ssp_name_field" );
...
function advancePopup() {
    if ( agreementPage === 1 ) {
        ...
        startPopupTextInputField.style.display = "block";
        startPopupScroll.style.display = "block";
        setScrollContent( 2 );
        setContent( 2 );
        var name = startPopupTextInputField.value;
        ...
        startPopupTextInputField.style.display = "none";
...
function setScrollContent( page ) {
    if ( page === 1 ) {
        startPopupScroll.innerHTML = '<p><p></p>Parental Passive Consent Letter for Online Study</p>' +
        '<p><p></p>Title of Research: True Game Based Solution, Applications for STEM Education Evaluation Study</p>' +
'<p><p></p>Funding Agency/Sponsor:  Department of Defense, Advanced Distributed Learning (ADL) Colab</p>' +
'<p><p></p>Study Investigators: Dr. Freeman (Principal Investigator), Dr. Oden (Researcher)</p>' +
'<p><p></p>What is the purpose of the research? We are studying whether a new web-based educational game, called True Game,' + 
...
'<p><p></p><p><p></p>For how long is my child expected to be in this study, and how much of my child’s time is required?</p> <p><p></p>' +
...
'<p><p></p><p><p></p>What are the risks of taking part in this study and how will they be minimized? <p><p></p> Risks are minimal, however, ' +
...
'<p><p></p>What are the benefits for taking part in the study? Your child will get extra practice in math, programming, ' +
...
'<p><p></p>What is an alternate procedure(s) that I can choose instead of having my child take part in this study? </p>' +
'<p><p></p><p><p></p>Participation is purely voluntary, on your child’s own time.</p>' +
'<p><p></p>Will the sessions be recorded? No, your child will not be recorded.' + 
'<p><p></p>Will data be collected about my child? Data will be collected from the True Game program logs, including the' + 
'number of minutes that students are logged into the game and the various parts of the game they used. Data ' +
'<p><p></p>will not be associated with any individual student. ' +
'<p><p></p>How will my child’s confidentiality be protected? We will not ask for your child’s name. Your child will ' +
...
'<p><p></p>Is my child’s participation voluntary? Yes. ' +
'<p><p></p>Can my child stop taking part in this research? Yes, either before or during the study without any penalty.' +
'<p><p></p>What are the procedures for withdrawal? Your child may simply stop playing. Alternatively, you or your child ' +
...
'<p><p></p>Will I be able to view surveys, assessments, and instructional materials used in this research? Yes.' +
'<p><p></p>Who should I contact if I have questions regarding the study? Please contact Barbara Freeman with any ' +
'questions at 970-379-4234 or barbarafreeman1@comcast.net. ' +
'<p><p></p>Who should I contact if I have concerns regarding my child’s rights as a study participant?' +
'<p><p></p>Ethical & Independent (E&I) Review Services, an Institutional Review Board who reviewed the study for ' +
'subject safety, by phone 800-472-3241 or by email at subject@eandireview.com' +

'<p><p></p>Parent please be aware that under the Protection of Pupil Rights Act. 20 U.S.C. Section 1232 (c)(1)(A),' + 
...
startPopupScroll.scrollTop = 0;
        ...
        startPopupScroll.innerHTML = '<p><p></p>Student Assent Letter for Online Study' +
'<p><p></p>STUDENT’S PERMISSION TO PARTICIPATE IN RESEARCH' +
'<p><p></p>Title of Research: True Game Based Solution, Applications for STEM Education Evaluation Study' +
'<p><p></p>Funding Agency/Sponsor: Department of Defense, Advanced Distributed Learning (ADL) Colab' +
'<p><p></p>Study Investigators: Dr. Freeman (Principal Investigator), Dr. Oden (Researcher)' +
'<p><p></p>What is the purpose of the research? We are studying whether a new web-based educational game, called True Game, ' +
...
'<p><p></p>How many children will take part in this study? Up to 8,600 ninth- and tenth-grade students nationwide.' +
'<p><p></p>What do I need to do? You will be asked to participate in a study of an educational game called True Game.' + 
'<p>If you choose to participate, you will sign-in to the True Game website. You will be asked to answer a few ' +
...
'<p>How long will it take? The study will take place during the months of March to September. The amount ' +
'of time you spend on the game is up to you.' +
'<p>What are my risks? You may feel some anxiety about participating and worry about how well you play or' + 
...
'<p>How might I benefit? You will get extra practice in math, programming, and problem solving and may ' +
...
'<p>Will I get anything for participating? Prizes such as gift cards will be awarded randomly to participants.' +
'<p>What would I do if I didn’t do this study? Participation is purely voluntary, on your own time.' +
'<p>Will the sessions be recorded? No, you will not be recorded. ' +
'<p>Will data be collected? Data will be collected from the True Game program logs, including ' +
...
'<p>How will my name be used? Or, in other words, how will you keep my information ' +
...
'<p>Do I have to participate? Or, in other words, is my participation voluntary? Your ' +
'participation is voluntary. You do not have to participate. ' +
'<p>Can I stop if I don’t want to do it anymore? In other words, what are the withdrawal ' +
'procedures? You can stop at any time without any consequences. ' +
'<p>Will I get a copy of this letter? Yes, it will be available online and you can print a' +
 'hard copy or request a copy from the researchers.' +
'<p>Who do I talk to if I have questions regarding this study? You can talk to your teacher ' +
...
'<p>Who should I contact if I have concerns regarding my rights as a study participant? ' +
...
'--------------' +
'<p>Your signature below indicates that you have read or been read the information ' +
